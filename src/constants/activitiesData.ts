// No imports — zero dependency chain, guaranteed fresh bundle by Metro.
// This file is intentionally self-contained so it cannot be broken by
// a stale module cache of any other file.

export const INLINE_ACTIVITIES = [
  {
    id: '1',
    title: 'Gratitude Mapping',
    description:
      'Map the people who have positively impacted you and find concrete ways to express appreciation.',
    steps: [
    ...
    neuroscienceTip:
      'Practicing gratitude activates dopaminergic reward pathways and shifts attention toward safety and connection, buffering against stress.',
  ...
  },
  {
    ...
    steps: [
      ...
      'For each person, note one way they tend to support you.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Focus on mirroring back what you heard rather than solving.',
      'Ask one open question that invites them to say more.',
      'Write down one moment where you noticed a shift in their energy.',
    ],
    neuroscienceTip:
  ...
  },
  {
    ...
    neuroscienceTip:
      'Rupture-repair cycles in relationships actually strengthen trust. Repair activates the parasympathetic nervous system and signals safety.',
    category: 'relationship',
    estimatedMinutes: 14,
    imageUrl:
  ...
  },
  {
    ...
    neuroscienceTip:
      'Interoceptive awareness activates the insula cortex and helps regulate emotional intensity.',
    category: 'self',
    estimatedMinutes: 10,
    imageUrl:
  ...
  },
  {
    ...
    steps: [
      ...
      'Write one action to honour your lowest-rated value this week.',
    ],
    neuroscienceTip:
      'Reflecting on personal values activates the ventromedial prefrontal cortex, linked to self-continuity and long-term motivation.',
    category: 'self',
    estimatedMinutes: 15,
    imageUrl:
  ...
  },
  {
    ...
    steps: [
      ...
      'Write 3–5 sentences as if you are a compassionate friend responding.',
    ...
    neuroscienceTip:
      'Self-compassion practices reduce cortisol and increase heart rate variability, signalling safety to the nervous system.',
    category: 'self',
    estimatedMinutes: 12,
    imageUrl:
  ...
  },
  {
    ...
    neuroscienceTip:
      'Naming a fear reduces amygdala activation and increases prefrontal control, making it easier to act despite discomfort.',
    category: 'growth',
    estimatedMinutes: 14,
    imageUrl:
  ...
  },
  {
    ...
    steps: [
      ...
      'Imagine the version of yourself who has grown past this.',
      'Design a 5-minute experiment you can run today.',
  ...
  },
  {
    ...
    steps: [
      ...
      'List three things you learned or that unexpectedly resulted from it.',
      'Identify one assumption this failure challenged.',
      'Write: "Because of this, I am now better prepared to…"',
    ],
    neuroscienceTip:
      'Post-failure reflection engages the anterior cingulate cortex to update predictions, converting disappointment into adaptive learning.',
    category: 'growth',
    estimatedMinutes: 10,
    imageUrl:
